#! /bin/bash
# Runs a docker container for PX4 + ROS 2 Jazzy dev environment
# Requires:
#   - docker
#   - nvidia-docker
#   - an X server
...
#
# Authors: Abdulrahman S. Al-Batati <asmalbatati@hotmail.com>
...
# DOCKER_REPO="px4-dev-ros2-jazzy:latest"
DOCKER_REPO="px4-dev-simulation-ubuntu24"
# DOCKER_REPO="osrf/ros:jazzy-desktop"
CONTAINER_NAME="px4_ros2_jazzy"
WORKSPACE_DIR=/media/asmbatati/UbuntuBackup/Docker/docker_shared_volumes/${CONTAINER_NAME}_shared_volume
CMD=""
DOCKER_OPTS=""
...
if [ "$(docker ps -aq -f name=${CONTAINER_NAME})" ]; then
    ...
    #     cd $CATKIN_WS/src
    #     git clone https://${GIT_USER}:${GIT_TOKEN}@github.com/example/project.git
    #     fi && \
